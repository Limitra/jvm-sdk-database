...
/**
  * DbSourceScale is the abstract class representing our scalable database.
  ...
  */
abstract class DbSourceScale extends MySQLProfile.API {
  abstract class DbProfile(configName: String) {
  ...
  abstract class DbMaster(configName: String) extends DbProfile(configName) {
  ...
  abstract class DbSlave(configName: String) extends DbProfile(configName) {
